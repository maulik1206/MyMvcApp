...
namespace MyMvcApp.Infrastructure.Repositories
{
    public class UserRepository : IUserRepository
    {
        ...
        public async Task UpdateUserAsync(User user) { _context.Users.AddOrUpdate(user); await _context.SaveChangesAsync(); }
        ...
        public async Task<User> GetUserByEmail(string email) => await _context.Users.FirstOrDefaultAsync(a=> a.Email == email);
    }
}
